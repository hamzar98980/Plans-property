...
<?php if (isset($_GET['success'])) { ?>
 ...
 <?php } ?>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                   All users in the designation of Checker
                  </div>
   ...
   <div class="table-responsive">
     <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
       ...
       <tbody>
           ...
           <?php 
           $sql_fetch = "SELECT u_id,u_name,u_email,u_pass,u_contact,u_cnic,u_addres,u_city,ad_dest from a_user join a_dest ON u_dest = ad_id where ad_dest = 'Checker'";
