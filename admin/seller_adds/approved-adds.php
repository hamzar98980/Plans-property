                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <?php 
                        $sql_quey= "SELECT a_id,a_title,a_price,a_cat,a_type,a_city,a_bad,a_bath,a_loc,a_area,a_status,a_desc,ag_id,s_name from s_add inner join s_regist on ag_id = s_id where a_status = 'Approved'";
