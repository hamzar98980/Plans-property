                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <?php 
                            $sql_fetch = "SELECT u_id,u_name,u_email,u_pass,u_contact,u_cnic,u_addres,u_city,ad_dest from a_user join a_dest ON u_dest = ad_id";
                               ...
                               <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      <a href="user-edit.php?edit=<?php echo $r['u_id'] ?>" class="dropdown-item has-icon"><i class="fas fa-pen"></i> Edit</a>
                                      <div class="dropdown-divider"></div>
                                      <a href="user-del.php?del=<?php echo $r['u_id'] ?>" class="dropdown-item has-icon text-danger"><i class="far fa-trash-alt"></i>
                                        Delete</a>
                                    </div>
                                  </div>
                                </td>
