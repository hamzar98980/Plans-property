...
session_start();
    ...
    // $comm = $_POST['commercial'];
        ...
        if(empty($_POST['title']))
            ...
            {
                if(!preg_match("/^[^`]{10,150}$/",$_POST['adrs']))
                {
            ...
            {
                if(!preg_match("/^[^`]{25,600}$/",$_POST['Desc']))
                {
...
if($head=="Location: addProperty.php?")
{


    $sql_insert = "INSERT into s_add(a_title,a_price,a_cat,a_type,a_city,a_bad,a_bath,a_loc,a_area,a_desc,ag_id,a_date,
    cable,electric,gas,water,balcony,kitchen,dining,draw_room,tv_lounge,hot_water,mosque,secutity_guard,park,garage,nera_commercail) 
    values ('$title','$price','$purpose','$type','$city','$bed','$bath','$adrs','$area','$Desc','$id','$dat',
    '$cable','$electric','$gas','$water','$balcony','$kitchen','$dining','$drawing','$tv','$hot_water','$mosque','$security','$park','$garage','$comm')";
