...
$eid=dect($_GET["id"]);
$sql = "SELECT * from s_add where a_id = '$eid'";
            ...
            <div class="card ">
                ...
                <div class="card-body shadow-lg p-5 ht1">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-8"><input type="text" name="title" value="<?php echo $row['a_title'];?>" id="title" class="form-control" aria-describedby="titlehelp">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8"><textarea name="Desc" id="Desc" class="form-control" aria-describedby="Deschelp"><?php echo $row['a_desc'];?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6"><input type="text" name="adrs" id="adrs" value="<?php echo $row['a_loc'];?>" class="form-control" aria-describedby="adrshelp">
                            ...
                            <div class="col-sm-2">
                             ...
                             <select name="city" id="" class="form-control select2" searchable="Search here..">
                                ...
                                foreach($json_data as $data)
                                {
                                  //echo $data['city'];
                                ?>
                                  <option  value="<?php echo $data['city'] ?>" <?php if($data['city']==$row['a_city']){echo "Selected";}?>><?php echo $data['city'] ?></option>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bed" value="<?php echo $row['a_bad'];?>" id="bed" class="form-control" placeholder="" aria-describedby="bedId">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="area" id="area" value="<?php echo $row['a_area'];?>" class="form-control"aria-describedby="areaId">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bath" id="bath" class="form-control" value="<?php echo $row['a_bath'];?>" placeholder="" aria-describedby="bathId">
                        ...
                        <?php 
                        $imgid=$row['a_id'];
                        $sql = "SELECT * from aimg where ai_id = '$imgid'";
                        
                        $resum = mysqli_query($con, $sql);
                  ...
                  <div class="form-group row">
                            ...
                            <table class="table mb-0">
                                ...
                                for($i=0;$i<count($images);$i++){
                                    ?>
                                              <tr class='pip'>
                <td class="tb-val"><img class='imageThumb' src= "images/<?php echo $images[$i];?>" title= "<?php echo $images[$i];?>" ></td>
                <td class="tb-val title" data-title="<?php echo $images[$i];?>" ><p><?php echo $images[$i];?></p></td>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="" class="form-control">
                                            <option value="Home" <?php if($row['a_type']=="Home"){echo "Selected";}?>>Home</option>
                                            <option value="Plot" <?php if($row['a_type']=="Plot"){echo "Selected";}?>>Plot</option>
                                            <option value="Commercial" <?php if($row['a_type']=="Commercial"){echo "Selected";}?>>Commercial</option>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="purpose" id="purpose" class="form-control">
                                            <option value="Rent" <?php if($row['a_cat']=="Rent"){echo "Selected";}?>>Rent</option>
                                            <option value="Sell" <?php if($row['a_cat']=="Sell"){echo "Selected";}?>>Sell</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" aria-describedby="priceId" value="<?php echo  $row['a_price'];?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <h4 class="f1"><b> Home Features</b></h4>
                                            ...
                                            <input type="checkbox" name="cable" value="1" <?php if($row['cable']=="1"){echo "Checked";}?>/>
                                            ...
                                            <div class=" col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="electric" value="1" <?php if($row['electric']=="1"){echo "Checked";} ?>/>
                                            <div class="state p-success">
                                                <i class="icon fa fa-check"></i>                                               
                                            ...
                                            <div class=" col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="gas" value="1" <?php if($row['gas']=="1"){echo "Checked";} ?> />
                                            ...
                                            <div class=" col-sm-2  pretty p-icon p-smooth">
                                            <input type="checkbox" name="water" value="1" <?php if($row['water']=="1"){echo "Checked";} ?>/>
                                            ...
                                            <div class=" col-sm-2  pretty p-icon p-smooth">
                                            <input type="checkbox" name="balcony" value="1"<?php if($row['balcony']=="1"){echo "Checked";} ?> />
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <h4 class="f1"><b> Home Features</b></h4> -->
                                                        <br>
                                            <div class="col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="kitchen" value="1" <?php if($row['kitchen']=="1"){echo "Checked";} ?>/>
                                            <div class="state p-success">
                                                <i class="icon fa fa-check"></i>
                                                <label>Kitchen</label>
                                            </div>
                                            ...
                                            <div class="col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="dining"  <?php if($row['dining']=="1"){echo "Checked";} ?> value="1"/>
                                            <div class="state p-success">
                                                <i class="icon fa fa-check"></i>                                               
                                            ...
                                            <div class="col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="dra_room" value="1" <?php if($row['draw_room']=="1"){echo "Checked";} ?>/>
                                            ...
                                            <div class="col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="tv_long" value="1" <?php if($row['tv_lounge']=="1"){echo "Checked";} ?> />
                                            ...
                                            <div class="col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="hot_water" value="1" <?php if($row['hot_water']=="1"){echo "Checked";} ?> />
                                    ...
                                    <div class="row">
                                        ...
                                        <h4 class="f1"><b> Area Features</b></h4>
                                                        <br>
                                            <div class=" col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="mosque" value="1" <?php if($row['mosque']=="1"){echo "Checked";} ?>/>
                                            <div class="state p-success">
                                                <i class="icon fa fa-check"></i>
                                                <label>Mosque</label>
                                            </div>
                                            ...
                                            <div class=" col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="security" value="1" <?php if($row['secutity_guard']=="1"){echo "Checked";} ?>/>
                                            <div class="state p-success">
                                                <i class="icon fa fa-check"></i>                                               
                                            ...
                                            <div class=" col-sm-2 pretty p-icon p-smooth">
                                            <input type="checkbox" name="park" value="1" <?php if($row['park']=="1"){echo "Checked";} ?>/>
                                            ...
                                            <div class=" col-sm-2  pretty p-icon p-smooth">
                                            <input type="checkbox" name="garage" value="1" <?php if($row['garage']=="1"){echo "Checked";} ?>/>
                                            ...
                                            <div class=" col-sm-2  pretty p-icon p-smooth">
                                            <input type="checkbox" name="commercial" value="1" <?php if($row['nera_commercail']=="1"){echo "Checked";} ?>/>
